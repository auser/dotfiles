...
-- Quickfix actions
M.keymap("n", "<leader>qe", "<CMD>lua require('auser.diagnostics').errors_to_quickfix()<CR><CMD>copen<CR>")
M.keymap("n", "<leader>qw", "<CMD>lua require('auser.diagnostics').warnings_to_quickfix()<CR><CMD>copen<CR>")
M.keymap_lua("n", "<leader>qo", "require('auser.keymap').quickfix_toggle()")
M.keymap_lua("n", "<leader>ql", "require('auser.keymap').quickfix_clear()")
M.keymap_lua("n", "<leader>qt", "require('telescope.builtin').quickfix()")
M.keymap_lua("n", "<leader>j", "require('auser.keymap').qf_next()")
M.keymap_lua("n", "<leader>k", "require('auser.keymap').qf_prev()")
