...
M.setup = function()
  ...
  vim.cmd("autocmd CursorHoldI,CursorMovedI * lua require('auser.statusline').doc_signature_str()")
end
...
vim.api.nvim_command([[  au ColorScheme * lua require'auser.statusline'.create_highlights()]])
...
local function create_au()
  vim.api.nvim_command("au BufEnter * lua require'auser.statusline'.make_status_line(true)")
  vim.api.nvim_command("au BufLeave * lua require'auser.statusline'.make_status_line(false)")
end
